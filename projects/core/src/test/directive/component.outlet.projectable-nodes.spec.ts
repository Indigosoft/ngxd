import { Component, Input, NgModule, TemplateRef, ViewChild, ViewContainerRef } from '@angular/core';
...
@Component({
    ...
    template: `
        <app-test-host [name]="name" [ngxComponentOutlet]="component" [ngxComponentOutletContent]="projectableNodes"></app-test-host>
