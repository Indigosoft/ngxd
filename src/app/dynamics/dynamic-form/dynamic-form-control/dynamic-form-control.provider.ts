...
export type FormControlProvider = NgxdProvider<Type<FormControlSchema>, Type<DynamicFormControlComponentBase>>;

export const FORM_CONTROL_PROVIDER = new InjectionToken<FormControlProvider[]>('Form Control Provider');

export function provideControl(type: Type<FormControlSchema>, component: Type<DynamicFormControlComponentBase>): Provider {
    return [
