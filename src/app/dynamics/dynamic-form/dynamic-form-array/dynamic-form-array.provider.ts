...
export type FormArrayProvider = NgxdProvider<Type<FormArraySchema>, Type<DynamicFormArrayComponentBase>>;

export const FORM_ARRAY_PROVIDER = new InjectionToken<FormArrayProvider[]>('Form Array Provider');

export function provideFormArray(type: Type<FormArraySchema>, component: Type<DynamicFormArrayComponentBase>): ValueProvider[] {
    return [
