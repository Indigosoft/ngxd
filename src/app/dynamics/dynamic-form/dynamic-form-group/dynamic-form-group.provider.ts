...
export type FormGroupProvider = NgxdProvider<Type<FormGroupSchema>, Type<DynamicFormGroupComponentBase>>;

export const FORM_GROUP_PROVIDER = new InjectionToken<FormGroupProvider[]>('Form Group Provider');

export function provideFormGroup(type: Type<FormGroupSchema>, component: Type<DynamicFormGroupComponentBase>): Provider {
    return [
