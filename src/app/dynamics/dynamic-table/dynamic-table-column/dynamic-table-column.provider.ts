...
export type TableColumnProvider = NgxdProvider<TableColumnTypes, Type<DynamicTableColumnComponentBase>>;

export const TABLE_COLUMN_PROVIDER = new InjectionToken<TableColumnProvider[]>('Table Column Provider');

export function provideTableColumn(type: TableColumnTypes, component: Type<DynamicTableColumnComponentBase>): Provider[] {
    return [
