import {
    Component, EventEmitter, Input, NgModule, OnChanges, OnInit, Output, SimpleChanges, TemplateRef, ViewChild, ViewContainerRef
} from '@angular/core';
...
@NgModule({
    ...
    declarations: [
        ...
        WithGetterTestHostComponent, WithSetterTestHostComponent, WithGetterAndSetterTestHostComponent
    ],
    exports: [
        AppComponent,
        TestComponent, TestHostComponent,
